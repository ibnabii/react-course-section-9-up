...
export default function Signup() {
  function signupAction(__prevFormState, formData) {
  ...
  let [formState, formAction, __pending] = useActionState(signupAction, {
    errors: null,
  });
    ...
    <form action={formAction}>
      ...
      <p className="form-actions">
        <button
          ...
          onClick={() => (formState = { errors: null, enteredValues: null })}
        >
          Reset
        </button>
